...
class Public_Image extends StatefulWidget {
  Public_Image({Key? key}) : super(key: key);

  @override
  State<Public_Image> createState() => _Public_ImageState();
}

class _Public_ImageState extends State<Public_Image> {
  CollectionReference noteref =FirebaseFirestore.instance.collection("public");
  late Reference ref;
  late File file ;
                ...
                InkWell(
                  onTap: ()async{
                    ...
                    if(picker != null){
                      ...
                      ref = FirebaseStorage.instance.ref("image").child(nameimage);
