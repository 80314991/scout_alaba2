...
class addimage extends StatefulWidget {
  var rahet , role , name;
   addimage({Key? key ,required this.rahet ,required this.role,required this.name}) : super(key: key);

  @override
  State<addimage> createState() => _addimageState(rahet , role , name);
}
...
class _addimageState extends State<addimage> {
  ...
  _addimageState(this.rahet , this.role ,this.name);
