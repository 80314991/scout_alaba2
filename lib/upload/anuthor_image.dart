...
class Anuthor_Upload_Image extends StatefulWidget {
  var rahet , role , name;
  Anuthor_Upload_Image({Key? key,required this.rahet ,required this.role,required this.name}) : super(key: key);

  @override
  State<Anuthor_Upload_Image> createState() => _Anuthor_Upload_ImageState( rahet , role , name);
}

class _Anuthor_Upload_ImageState extends State<Anuthor_Upload_Image> {
...
_Anuthor_Upload_ImageState(this.rahet , this.role, this.name);
@override
